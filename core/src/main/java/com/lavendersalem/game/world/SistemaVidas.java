...
public class SistemaVidas {
    ...
    public void cederVidas(float delta, float spawnLavX, float spawnLavY) {
        if (esperaRescate) { // Si esta esperando rescate
            ...
            float distancia = Vector2.dst(lavender.b2body.getPosition().x, lavender.b2body.getPosition().y,
                salem.b2body.getPosition().x, lavender.b2body.getPosition().y);
